...
function isPcm16Stream(start: InboundAudioStreamStartFrame): boolean {
...
function wrapPcm16AsWav(pcm: Uint8Array, sampleRateHz: number, channels: number): Uint8Array {
  const headerSize = 44;
