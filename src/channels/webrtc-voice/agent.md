...
- WebRTC voice and TalkRuntime must not block or reinterpret exposed tools. Tool availability belongs to request construction; exposed tool calls must return through the common function-call loop.
