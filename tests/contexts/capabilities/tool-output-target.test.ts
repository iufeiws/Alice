...
const defaultTarget = { plugin: "feishu", channelId: "default-chat", sessionId: "default-session" };

function createResolver() {
  return createToolOutputTargetResolver({
...
test("tool output target resolver returns undefined without requester target or default target", () => {
