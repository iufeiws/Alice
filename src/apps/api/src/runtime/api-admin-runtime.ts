...
import type { ApiRuntimeState } from "./api-lifecycle-runtime.js";
...
export function createApiAdminRuntime(input: {
  ...
  const requestHandler = createAdminRequestHandlerRuntime({
    ...
    getMemoryLLMSessions: input.adminLLMSessionRuntime.memoryLLMSessionRuntime.getMemoryLLMSessions,
    getLLMSession: input.adminLLMSessionRuntime.memoryLLMSessionRuntime.getMemoryLLMSession,
    store: input.store,
