...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", default="assets/plugin/tts/model")
    parser.add_argument("--reference-audio", default="assets/plugin/tts/tts_sorce.mp3_0009628480_0009775040.wav")
