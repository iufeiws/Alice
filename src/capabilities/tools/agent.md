...
- Keep render-layer formatting out of message data. Channel-specific display markup belongs only in the final channel send payload, never in `AgentOutput`, stored messages, tool results, or chat history shown back to the LLM.
